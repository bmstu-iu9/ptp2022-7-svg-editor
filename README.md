...
* [Работа в файлами](#работа-с-файлами)
...
* ![login](https://user-images.githubusercontent.com/67114367/188319380-25e9c9a0-c189-4097-9028-1e82dc4408ac.png)
  ...
  * ![password_reset_confirm](https://user-images.githubusercontent.com/67114367/188332362-aad8d610-8686-49af-adc7-d9b042bc7a94.png)
## Личный кабинет
...
* ![start](https://user-images.githubusercontent.com/67114367/188332218-dd3e5fef-15be-4332-bc51-a180eb8a97fe.png)
* Вы можете создать новый файл, выбрав один из двух доступных форматов – svg или yml.
* ![start_choose](https://user-images.githubusercontent.com/67114367/188332414-100098e3-d62c-4315-a946-e9b951029ef1.png)
...
* ![start_approve](https://user-images.githubusercontent.com/67114367/188332774-117de8ed-15fc-4390-b648-81fa958182b8.png)
...
* ![start_open](https://user-images.githubusercontent.com/67114367/188332976-b971f7f5-2aaa-4e50-b4cf-a5e1e08b40c0.png)
...
* ![start_saved](https://user-images.githubusercontent.com/67114367/188333223-a4192f94-ec8d-4002-88b3-972c6abc4aa6.png)
...
* ![text-window](https://user-images.githubusercontent.com/60570949/188899777-636a6d45-d0f0-481b-91bf-4b36dfc566cd.png)
### Заливка
...
* ![undo_button](https://user-images.githubusercontent.com/60570949/188898622-c2156156-4157-46b8-9179-47c0df91e986.png)
* ![redo_button](https://user-images.githubusercontent.com/60570949/188898846-e3508a20-a125-41f6-b444-8de587b202ed.png)
...
* ![new_button](https://user-images.githubusercontent.com/60570949/188887240-25449dbc-bf83-4be9-91ae-b816bd7a10e0.png)
...
* ![file_success](https://user-images.githubusercontent.com/60570949/188887563-33ec7e70-35d2-433b-8092-18dae75ce57c.png)
* В противном случает кнопка не будет активной и поле ввода имени файла будет подсвечиваться красным цветом.
* ![file_error](https://user-images.githubusercontent.com/60570949/188887860-3d40555e-466f-468b-a2f5-a1da3ae68adf.png)
...
* ![save_button](https://user-images.githubusercontent.com/60570949/188887995-089c6a90-033d-4e40-b0ff-4e7c09f32a3d.png)
...
* ![save_as_button](https://user-images.githubusercontent.com/60570949/188888192-6f3e8569-b99c-42aa-8540-af40376cea56.png)
...
* ![edit_button](https://user-images.githubusercontent.com/60570949/188888795-678a617f-6726-4f2c-a421-b081ccd6e76d.png)
* Откроется окошко в котором из предложенного списка нужно выбрать (нажать) нужный файл, и, после нажатия кнопки `OK`, выбранный файл появится в редакторе.
* ![file_set](https://user-images.githubusercontent.com/60570949/188889098-d62a0111-762d-4918-a71e-02426dea74da.png)
* ![file_set_ok](https://user-images.githubusercontent.com/60570949/188889111-d163b84a-7904-4a2c-8723-4a7f3bff16d6.png)
### Удаление файлов
* Чтобы удалить ненужный файл или файлы, выберете `Manage`->`Delete`.
* ![delete_button](https://user-images.githubusercontent.com/60570949/188889602-7fe9a971-62a7-44e5-9dd4-0d3fa49910e1.png)
* Так же как и с открытием файла, ненужный файл нужно выбрать из списка и нажать `OK`, после чего файл с сервера будет удален.
* ![delete_file_set](https://user-images.githubusercontent.com/60570949/188889742-76f601c1-4b4d-44bd-b2eb-ef535e0e5176.png)
...
* ![delete_file_set_ok](https://user-images.githubusercontent.com/60570949/188889888-71f91bfd-93dd-4135-a383-fc5793c0219d.png)
### Загрузка файлов
...
* ![open_button](https://user-images.githubusercontent.com/60570949/188890171-081a7acc-7a75-4f58-a1ac-342995e110af.png)
* ![open_ok](https://user-images.githubusercontent.com/60570949/188890387-3d723859-e329-4e0a-b640-17fc62dfa809.png)
...
* ![download_button](https://user-images.githubusercontent.com/60570949/188890724-0693a113-7a2d-4c92-956b-641236ee5a72.png)
...
![layers-panel-button](https://user-images.githubusercontent.com/108520625/189074537-5e1065da-6fef-4a3f-b6a9-2b8f74620636.png)
...
![layers-panel](https://user-images.githubusercontent.com/108520625/189075473-52936767-4cba-4e6a-8036-ee04933ac15a.png)
...
![opacity-slider](https://user-images.githubusercontent.com/108520625/189082105-6d7dfda0-f271-4fb8-affc-4dd89a82e469.png)
* Уровень прозрачности слоя сохраняется при сохранении проекта.
#### 4. Отключение
* Отключить слой можно убрав галочку рядом с его именем.

![layer-off](https://user-images.githubusercontent.com/108520625/189082284-32762be0-07b2-4b0e-b0d9-e40a507a1e18.png)
...
![merge-visible](https://user-images.githubusercontent.com/108520625/189082431-08e3aad0-ecdc-48a1-a633-5e8c70c7d920.png)
![merged-visible](https://user-images.githubusercontent.com/108520625/189082529-a37e8c21-a239-4ec9-98da-b308eae1e7b5.png)
...
![create-visible](https://user-images.githubusercontent.com/108520625/189083031-b7ade5de-bba2-40f8-b5b5-0dbc2c80f919.png)

## Форматы
Редактор поддерживает два формата файлов `svg` и `yml`.
### SVG
`SVG` - это стандартный формат векторной графики, он широко используем, поэтому вы можете открыть и использовать его почти в любых программах поддерживающих векторную графику и конечно в других редакторах.
Однако `SVG` формат не очень хорошо подходит для глубокой работы со слоями.
Поэтому, при использовании этого формата в нашем редакторе, вы конечно сможете использовать функционал слоев, однако при хранении файла вся работа со слоями не сохраняется, и поэтому при повторном редактировании файла все созданные вами слои сольются в один.
### ILLUSTRATION (YML)
Illustration - это наш собственный формат масштабируемой векторной графики с полноценной поддержкой слоев. Он основан на языке разметки `yml`, и позволяет в полной мере реализовать работу со слоями.
...
Но, зато самом редакторе, при использовании данного формата, при хранении будут сохраняться все созданные ранее слои.
И при повторном редактировании файла вы сможете работать с теми же слоями с которыми работали раннее.
### Конвертация
Конечно же наш веб-редактор поддерживает полную конвертацию форматов, поэтому вы, например, можете создать и работать с файлами формата `yml`, а перед загрузкой на свой компьютер, просто сохранить из как `svg` и использовать в сторонних программах.
## Проекты
...
* ![project_file_open](https://user-images.githubusercontent.com/60570949/188330619-28a8556f-f6e5-456c-9a70-9336f1f1eba7.png)
...
* ![project_file_change](https://user-images.githubusercontent.com/60570949/188330628-2fe257ec-0f63-49eb-8601-d6582c7b7c94.png)
### Закрытие файла
...
* ![project_file_change](https://user-images.githubusercontent.com/60570949/188330645-58cc5120-daf6-413a-8048-fb1c7caaf556.png)
...
# Авторство
### Состав команды:
* Виленский Сергей Дмитриевич (капитан) — _тимлид и ведущий `frontend` разработчик_ — **[![аватар Сергея](https://avatars.githubusercontent.com/u/102258145?s=20)AngelicHedgehog](https://github.com/AngelicHedgehog)**
* Фёдоров Владислав Павлович — _дизайнер и `frontend` разработчик_ — **[![аватар Влада](https://avatars.githubusercontent.com/u/52318064?s=20)GarryNeKasparov](https://github.com/GarryNeKasparov)**
* Гасаев Гамид Казимович — _ведущий `frontend` разработчик_ — **[![аватар Гамида](https://avatars.githubusercontent.com/u/108520625?s=20)wizardOfOz21](https://github.com/wizardOfOz21)**
* Выдрина Варвара Алексеевна — _дизайнер и `frontend` разработчик_ — **[![аватар Вари](https://avatars.githubusercontent.com/u/67114367?s=20)vyydra](https://github.com/vyydra)**
* Сатыбалдиев Талгат — _дизайнер и менеджер проекта_ — **[@SatybaldievT](https://github.com/SatybaldievT)**
* Кабанов Андрей Юрьевич — _техлид, ведущий `full-stack` разработчик, администратор БД и сисадмин_ — **[![аватар Андрея](https://avatars.githubusercontent.com/u/60570949?s=20)Kabane-UN](https://github.com/Kabane-UN)**
### Куратор:
