...
#### Разбиение
* При нажатии ЛКМ[^lkm] по объекту на координатах[^object_on_coords], если этот объект является путём, прямоугольником или эллипсом, он преобразуется в многоугольник с частотой вершин, равной значению параметра ширины контура на панели параметров рисования.
